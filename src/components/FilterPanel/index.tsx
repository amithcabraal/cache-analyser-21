...
function sortDomains(domains: string[]): string[] {
  return domains.sort((a, b) => {
    ...
    // Compare parts from right to left (TLD first)
    ...
    // If one domain is a subdomain of the other, shorter one comes first
    if (partsA.length !== partsB.length) {
      return partsA.length - partsB.length;
    }
    
    // If domains have same parts but different order, sort normally
